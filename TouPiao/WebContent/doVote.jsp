<%@page import="com.tp.toolbean.MyTools"%>
<%@page import="com.tp.valuebean.TempSingle"%>
...
<%
	String mess = "";	//用来保存提示信息
	String selectId = request.getParameter("ilike");		//获取用户的选择
	if(selectId == null || selectId.equals("")){	//如果没有选择投票选项
		mess = "请选择投票！";	
	} else {			//选择了投票选项
			...
			TempSingle single = myDb.sellectTemp(sql);
		...
		if(mark){	//如果允许投票
			...
			mess = "对不起，通过判断您的IP，您已经投过票了！<br>上次投票时间："+single.getVoteTime()+"<br>60分钟内不允许再进行投票！";				
		}
	}
